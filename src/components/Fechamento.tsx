...
export function Fechamento({ setView }: FechamentoProps) {
  ...
  return (
    <div className="p-6 max-w-6xl mx-auto font-sans space-y-8 text-left animate-in fade-in duration-500 mt-20">
      ...
      <header className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div className="flex items-center gap-4">
          <Button 
            ...
            className="rounded-full border-gray-200 hover:bg-gray-100 transition-all cursor-pointer"
          >
            <ArrowLeft size={16} className="mr-1" /> Voltar
          </Button>
          <div>
            <h1 className="text-2xl font-black text-[#0a2d54] uppercase flex items-center gap-3">
              <Scale className="text-[#bfa571]" size={28} /> Fechamento de Caixa
            </h1>
        ...
        <div className="flex items-center gap-2">
          ...
          />
          <Button onClick={() => window.print()} variant="outline" className="h-10 text-gray-400 hover:text-blue-600 cursor-pointer">
            <Printer size={20} />
          </Button>
        </div>
      </header>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <Card className="border-none shadow-sm bg-emerald-50 rounded-2xl">
          <div className="pb-2 flex flex-row items-center justify-between px-6 pt-4">
            <h3 className="text-[10px] font-black text-emerald-700 uppercase tracking-widest">Entradas Confirmadas</h3>
        ...
        <Card className="border-none shadow-sm bg-red-50 rounded-2xl">
          <div className="pb-2 flex flex-row items-center justify-between px-6 pt-4">
            <h3 className="text-[10px] font-black text-red-700 uppercase tracking-widest">Saídas Pagas</h3>
        ...
        <Card className={`border-none shadow-md rounded-2xl ${saldoFinal >= 0 ? 'bg-[#0a2d54] text-white' : 'bg-orange-600 text-white'}`}>
          <div className="pb-2 px-6 pt-4">
            <h3 className="text-[10px] font-black uppercase opacity-80 tracking-widest text-[#dfca9e]">Saldo do Caixa</h3>
          </div>
          <CardContent>
      ...
      <div className="grid md:grid-cols-2 gap-8">
        ...
        <Card className="shadow-sm border-gray-100 overflow-hidden rounded-2xl bg-white">
          <div className="bg-emerald-50/50 border-b px-6 py-4">
        ...
        {/* PAGAMENTOS (SAÍDAS) */}
        <Card className="shadow-sm border-gray-100 overflow-hidden rounded-2xl bg-white">
          <div className="bg-red-50/50 border-b px-6 py-4">
            <h3 className="text-xs font-black text-red-700 uppercase flex items-center gap-2">
