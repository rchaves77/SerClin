      ...
      <div className="max-w-md w-full text-center space-y-8 animate-in fade-in zoom-in duration-500">
        ...
        <div className="flex flex-col gap-4">
          <a 
            ...
            className="w-full bg-[#005183] hover:bg-[#003d63] text-white font-bold h-14 rounded-xl flex items-center justify-center gap-2 shadow-lg transition-all active:scale-95"
          >
          ...
          <Link 
            to="/" 
            className="w-full bg-white border border-slate-200 text-slate-600 font-semibold h-14 rounded-xl flex items-center justify-center gap-2 hover:bg-slate-50 transition-all shadow-sm"
          >
